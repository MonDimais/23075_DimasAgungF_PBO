...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String pwUser = password.getText();

        if("Dimas".equals(idUser) && "Bilek".equals(pwUser)) {
            new Kalkulator().setVisible(true);
            dispose();
        } else {
            JOptionPane.showMessageDialog(null,userID.getText()+", password anda salah", "pesan Kesalahan", JOptionPane.ERROR_MESSAGE);
            userID.setText("");
            password.setText("");
            userID.requestFocus();
        }
